<!-- jQuery 2.1.4 -->
    ...
    <script src="{{base_url()}}assets/admin-lte/plugins/morris/morris.min.js"></script>
    <!-- Sparkline -->
    <script src="{{base_url()}}assets/admin-lte/plugins/sparkline/jquery.sparkline.min.js"></script>
    <!-- jvectormap -->
    ...
    <!-- jQuery Knob Chart -->
    <script src="{{base_url()}}assets/admin-lte/plugins/knob/jquery.knob.js"></script>
    <!-- daterangepicker -->
